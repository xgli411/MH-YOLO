...
from ultralytics.nn.extra_modules.block import(CBAM,C2f_CBAM,MP,ScalSeq,Zoom_cat,Add)
try:
    import thop
except ImportError:
    thop = None
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3,C2f_CBAM,):
